...
export function AppHeader({ onMenuClick }: AppHeaderProps) {
  ...
  return (
    <header className="fixed top-0 safe-area-top left-0 right-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
